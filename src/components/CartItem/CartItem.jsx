...
export default function CartItem({ id, title, type, price, count, size, imageUrl }) {
  ...
  return (
    <div className='cart__item'>
      ...
      <div className='cart__item-count'>
        ...
        <b>{count}</b>
        <div onClick={addPizzaHandler} className='button button--outline button--circle cart__item-count-plus'>
          <svg
            width='10'
            height='10'
            viewBox='0 0 10 10'
